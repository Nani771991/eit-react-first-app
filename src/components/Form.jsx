...
const Form = () => {
    ...
    useEffect(() => {
        setErrors({
            name: values.name.length <=3 && values.name ? "El Nombre debe tener más de 3 caracteres" : "",
            lastname: values.lastname.length <=3 && values.lastname ? "El Apellido debe tener más de 3 caracteres" : "",
            pass: values.pass.length <=8 && values.pass ? "La clave debe tener más de 8 caracteres" : "",
        })
    },[values])
    ...
    const handleSubmit = e => {
        ...
        if (values.pass) {
            ...
            alert("Las password es obligatoria")
        }
    }
